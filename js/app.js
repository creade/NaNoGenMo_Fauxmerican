    ...
    $.when(
        ...
        var viewModel = {
            paras: [{
                ...
                {
                    text: "A game to end all of \'em. The <%= homeTeamFullName %>  hosting the <%= awayTeamFullName %>.  A game that supposed to last forever.",
                    data: {
